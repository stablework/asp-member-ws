...
\par
{\b {\i Independent Contributors-- (power/wisdom people)}}\par
\par
{\i Independent contributors} are action-oriented, solution driven and independent people. Business situations that require lasting structures or systems to be built must have a {\i power/wisdom person} at the helm. Whether the requirement is to make something that is complex simple, or to take a simple system and make it more robust and responsive to current needs, the {\i power/wisdom person} is the person for the job.\par
\par
{\i Independent contributors} conceive appropriate solutions and take immediate action. Implementing a solution to a problem is a rich form of reward for the {\i power person} and seeing a system put into effect is the highest acknowledgment for a {\i wisdom person}. The {\i power/wisdom person} designs a monument and then builds it.\par
\par
These powerful personalities are good in isolation. They thrive on independence and chaff under someone else's management. If given a general idea of the problem to be solved, or the monument to build, they will find a way to get it done.  But, give them their head and stand back. Without an open range to work in, their energy turns from creativity and action to clever evasion of restrictions, invisibility and possibly, even anger.\par
\par
{\i Power/wisdom people} are not intimidated by much of anything except intimate relationships and speaking to crowds. They are resourceful, agile, constantly in motion, clever, inventive, able to teach others ({\i wisdom}), and powerful in commanding a situation to bring about its desired effect ({\i power}). They derive their own solutions and put them into action without hesitation.\par
\par
In quickly changing environments, failing situations, and extreme growth opportunities, {\i power/wisdom people} are unmatched.\par
\par
{\i Independent contributors} believe they have the answer to every question and the power to do anything. Their {\i wisdom} value set develops one irrefutably valid solution after the next, and the {\i power} in them either pushes everyone out of the way while they implement the plan, or they direct someone else in the same manner on how to get the job done expediently.  In other words, if they can't do it themselves, they still expect it to be done exactly as they would have carried out the assignment.\par
\par
Since {\i power people} are impatient with the world, they may consider any teaching time to be "baby-sitting." {\i Power/wisdom people} are convinced they are self-sufficient. Since they are impatient, they also may find it difficult to be tutored and may feel their ideas are the only ones with any real merit.
